...
<template>
  <section aria-label="Why CSBigCaptain Blog" class="border-t border-outline-variant">
    <div class="flex h-70 w-full flex-col items-start justify-center px-5 md:h-70 md:px-15">
      <h2
        class="w-40 text-3xl leading-10 font-normal uppercase md:w-full md:text-5xl md:leading-16"
      >
        Why CSBigCaptain Blog?
      </h2>
      <p class="text-md pt-4 md:text-lg">
    ...
    >
      ...
      >
        ...
        <h3 class="pb-2 text-2xl font-bold text-on-surface">
          {{ item.title }}
        </h3>
    ...
    <div class="link flex items-center justify-center py-7">
      <AppLinkButton
        icon="mdi:github"
